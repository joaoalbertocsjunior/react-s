...
This project envisions a future where data-bound and ready-to-consume components can be fetched directly from apis and be sent or consumed over url params and body requests.
